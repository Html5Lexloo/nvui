    ...
    nvui.inherits(nvui.controls.Layout, nvui.core.UIComponent, {
        ...
        _render: function() {
            ...
            if ($("> div[position=top]", g.layout).length) {
                g.top = $("> div[position=top]", g.layout).wrap('<div class="l-layout-top"></div>').parent();
                g.top.content = $("> div[position=top]", g.top).addClass("l-layout-content");
            ...
            if ($("> div[position=bottom]", g.layout).length) {
                ...
                g.bottom.content = $("> div[position=bottom]", g.bottom).addClass("l-layout-content");
            ...
            if ($("> div[position=left]", g.layout).length) {
                g.left = $("> div[position=left]", g.layout).wrap('<div class="l-layout-left""></div>').parent();
                g.left.content = $("> div[position=left]", g.left).addClass("l-layout-content");
            ...
            if ($("> div[position=center]", g.layout).length) {
                ...
                g.center.content = $("> div[position=center]", g.center).addClass("l-layout-content");
                ...
                if ($("> div[position=centerbottom]", g.layout).length) {
                    ...
                    g.centerBottom.content = $("> div[position=centerbottom]", g.centerBottom).addClass("l-layout-content");
            ...
            if ($("> div[position=right]", g.layout).length) {
                ...
                g.right.content = $("> div[position=right]", g.right).addClass("l-layout-content");
